...
#%%
### Set Paths
binary_tokenizer_path = r'Streamlit_App/utils_DGA_BINARY/Binary_tokenizer.json'
class_tokenizer_path = r'Streamlit_App/utils_DGA_Classes/Class_tokenizer.json'

hot_encoder_path = r'Streamlit_App/utils_DGA_BINARY/hot_encode.sav'
label_encoder_path = r'Streamlit_App/utils_DGA_Classes/Label_encode.sav'


DGA_model = load_model(r'Streamlit_App/DGA_Binary_Model.h5')
class_classification = load_model(r'Streamlit_App/DGA_Class_Final_Model.h5')
